...
public class RestDmSchedulerSeatPriceService {
    ...
    public DmSchedulerSeatPrice getDmSchedulerSeatPriceBySchedulerIdAndArea(@RequestParam("areaLevel") Integer areaLevel, @RequestParam("scheduleId") Long scheduleId) throws Exception {
